...
def coarse_network_model():
    ...
    conv1 = Conv2D(96, (11, 11), strides=(4, 4), padding='same', kernel_regularizer=regularizers.l2(0.01))(first_layer)
    b1 = BatchNormalization()(conv1)
    a1 = Activation("relu")(b1)
    p1 = MaxPooling2D(pool_size=(2, 2))(a1)

    conv2 = Conv2D(256, (5, 5), padding='same', kernel_regularizer=regularizers.l2(0.01))(p1)
    b2 = BatchNormalization()(conv2)
    a2 = Activation("relu")(b2)
    p2 = MaxPooling2D(pool_size=(2, 2))(a2)

    conv3 = Conv2D(384, (3, 3), padding='same', kernel_regularizer=regularizers.l2(0.01))(p2)
    b3 = BatchNormalization()(conv3)
    a3 = Activation("relu")(b3)

    conv4 = Conv2D(384, (3, 3), padding='same', kernel_regularizer=regularizers.l2(0.01))(a3)
    b4 = BatchNormalization()(conv4)
    a4 = Activation("relu")(b4)

    Dlayer1 = Dense(256, kernel_regularizer=regularizers.l2(0.01))(a4)
    b5 = BatchNormalization()(Dlayer1)
    a5 = Activation("relu")(b5)
    p5 = MaxPooling2D(pool_size=(2, 2))(a5)

    flat = Flatten()(p5)
    flat = Dense(4096, kernel_regularizer=regularizers.l2(0.01))(flat)
    flat = BatchNormalization()(flat)
    flat = Activation("linear")(flat)
    flat = Dropout(0.4)(flat)

    flat = Dense(4070, activation='relu', kernel_regularizer=regularizers.l2(0.01))(flat)
    flat = BatchNormalization()(flat)
...
def refined_network_model():
    ...
    conv21 = Conv2D(63, (9, 9), strides=(2, 2), padding='valid', kernel_regularizer=regularizers.l2(0.01))(first_layer)
    b21 = BatchNormalization()(conv21)
    p21 = MaxPooling2D(pool_size=(2, 2))(b21)

    Concat = concatenate([coarse_output, p21])
    conv22 = Conv2D(64, (5, 5), padding='same', kernel_regularizer=regularizers.l2(0.01))(Concat)
    b22 = BatchNormalization()(conv22)

    out = Conv2D(1, (5, 5), padding='same', kernel_regularizer=regularizers.l2(0.01))(b22)
